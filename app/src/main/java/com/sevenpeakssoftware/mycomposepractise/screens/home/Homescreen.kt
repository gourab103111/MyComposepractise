package com.sevenpeakssoftware.mycomposepractise.screens.home
...
import com.sevenpeakssoftware.mycomposepractise.navigation.RoutesInformation
...
@Composable
fun MainContent(navController: NavController,itemLists:List<String> = listOf(
    "List  1",
    "Lists 2",
    "Lists 3",
            ...
            LazyColumn{
                items(items = itemLists){
                    rowBox(detailsText = it){
                        navController.navigate(route = RoutesInformation.Detailscreen.name+"/$it")
